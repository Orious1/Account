...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public String outSettingAdd(int uid, String bookKeepingName, String bookKeepingTypeName, JSONObject json) {
        List<String> l=(List<String>)json.get("json");
        StringBuilder basicFunds= new StringBuilder();
        for (String i:l) {
            if (i.contains("BO")) {
                basicFunds.append(i).append("-");
            }else {
        ...
        //要在bookkeeping_type和bookking表中添加一条记录
        return null;
    }

    @Override
    public String inSettingAdd(int uid, String bookKeepingName, String bookKeepingTypeName, JSONObject json) {
        return null;
    }
